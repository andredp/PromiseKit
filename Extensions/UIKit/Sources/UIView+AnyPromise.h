...
*/
+ (AnyPromise *)promiseWithDuration:(NSTimeInterval)duration
                         animations:(void (^)(void))animations NS_REFINED_FOR_SWIFT;
...
+ (AnyPromise *)promiseWithDuration:(NSTimeInterval)duration
                 ...
                 keyframeAnimations:(void (^)(void))animations NS_REFINED_FOR_SWIFT;
